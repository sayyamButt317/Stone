...
export default function ChooseGender({
    ...
    }, [onContinue, onOpenChange, selected])
        ...
        <Modal open={open} onOpenChange={onOpenChange}>
            ...
            >
                ...
                <div className="mx-auto w-full max-w-4xl shrink-0 px-6 pt-6 pb-4 md:px-24">
                    <Modal.Stepper step={step} totalSteps={totalSteps} label="Selection" />
                </div>
                ...
                >
                    <div className="mx-auto flex max-w-screen-2xl items-center justify-between gap-4">
                        ...
                        <button
                            ...
                            className="flex items-center gap-4 rounded-full bg-gradient-to-br from-[#e2c196] to-[#a58860] px-8 py-4 text-[10px] font-bold tracking-[0.3em] text-[#291800] uppercase shadow-[0_10px_30px_rgba(226,193,150,0.2)] transition-all duration-500 hover:scale-105 hover:shadow-[0_15px_40px_rgba(226,193,150,0.4)] active:scale-95 sm:px-10 sm:py-5"
                        >
                            Proceed to Carving
