...
export default function BraceletPage() {
    ...
    return (
        ...
        >
            ...
            <footer className="fixed bottom-0 left-0 z-50 flex h-24 w-full items-center justify-end bg-[#111413]/90 px-8 shadow-[0_-20px_40px_rgba(0,0,0,0.4)] backdrop-blur-2xl md:px-12">

                {/* Optional center text (keep absolute if you still want it centered) */}
